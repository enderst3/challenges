...
that takes an array of strings as an argument and returns a filtered array containing 
...
def goose_filter(birds):
    new_geese = []
    for bird in birds:
        if bird not in geese and bird not in new_geese:
            new_geese.append(bird)
    print(new_geese)
    return new_geese
